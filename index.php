...
<nav class="navbar navbar-expand-md navbar-dark bg-dark">
    <div class="container">
        <a class="navbar-brand" href="index.html">Roille Entreprise</a>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarsExampleDefault">
            <ul class="navbar-nav m-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="cart.html">Louer</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="contact.html">Nous contacter</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="contact.html">S'enregistrer</a>
                </li>
                <li class="nav-item">
            ...
            <form class="form-inline my-2 my-lg-0">
                ...
                <a class="btn btn-success btn-sm ml-3" href="cart.html">
                    <i class="fa fa-shopping-cart"></i> Achat
...
<section class="jumbotron text-center">
    <div class="container">
        <h1 class="jumbotron-heading">Roille Location de materiel de chantier </h1>
</section>
<div class="container">
    <div class="row">
        <div class="col">
